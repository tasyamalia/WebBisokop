...
<div class="paralax">
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
        <li class="active"><a href="indextasya2.html">HOME</a></li>
        <li><a href="#today">TODAY SHOW</a></li>
        <li><a href="#">MOVIES</a></li>
        <li><a href="#">SCHEDULE</a></li>
        <li><a href="logintasya.html">LOGOUT</a></li>
    </ul>
     <ul class="nav navbar-nav navbar-right">
        <li><a href="logintasya.html"><button type="button"  style="background-color: #17EFF9; border:transparent;" class="btn btn-default">LOGIN</button></a></li>
        <li><a href="#"><button type="button"  style="background-color: #17EFF9; border:transparent;" class="btn btn-default">DAFTAR</button></a></li>
    </ul>
  </div>
  </div>
</nav>
